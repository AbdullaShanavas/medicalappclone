...
import com.app.staycured.geoutils.GetNearbyPlacesData;
...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback ,
    ...
    private String getUrl(double latitude, double longitude, String nearbyPlace) {
        ...
        StringBuilder googlePlacesUrl = new StringBuilder("//maps.googleapis.com/maps/api/place/findplacefromtext/output?parameters");
